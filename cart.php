  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="https://www.facebook.com/hoang.nguyenhuu.7330763/">Contact For Us</a>
        </li>
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        foreach ($cart as $key => $value) {
                           ...
                           $idsong=$value['id'];
                            echo "<tr>";
                            echo "<td>$value1</td><td>$value2</td><td>$value5</td><td>$value4</td><td><img style='height:70px;width:120px' src='$value3' /></td><td><a href='delete.php?xoa=$idsong' class='btn btn-primary'>Xoá</a></td>";
                            echo "</tr>";
                            $sum+=$value2;
